...
import { MapPin, Moon, Sun, AlertCircle, RefreshCw } from 'lucide-react';
import { motion } from 'framer-motion';

export default function PrayerTimesCard() {
    const { data, loading, error, locationName, permissionGranted, requestLocation } = usePrayerTimes();
    ...
    return (
        <motion.div
            ...
            className="overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-white via-primary/5 to-secondary/30 shadow-xl shadow-primary/5 dark:from-zinc-900 dark:via-zinc-900/90 dark:to-zinc-800"
        >
