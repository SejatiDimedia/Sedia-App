...
async function main() {
    console.log("Starting migration for cascade delete on comments.article_id...");

    try {
        // Drop existing constraint
        console.log("Dropping existing constraint...");
        try {
            await sql(`ALTER TABLE "noltpedia_v1"."comments" DROP CONSTRAINT IF EXISTS "comments_article_id_articles_id_fk";`);
        ...
        await sql(`
            ALTER TABLE "noltpedia_v1"."comments"
